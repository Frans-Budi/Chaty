...
class AuthController extends GetxController {
  ...
  void addNewConnection(String friendEmail) async {
    ...
    if (docChats.docs.length != 0) {
      // User sudah pernah chat dengan siapa pun
      var checkConnection = await users
      ...
      if (checkConnection.docs.length != 0) {
        ...
        // Belum pernah chat dengan siapa pun
        // buat koneksi . . .
    ...
    if (flagNewConnection) {
      ...
      var chatDocs = await chats.where(
        'connection',
        whereIn: [
          [
            _currentUser!.email,
      ...
      if (chatDocs.docs.length != 0) {
        ...
        var chatDataId = chatDocs.docs[0].id;
        var chatsData = await chatDocs.docs[0].data() as Map<String, dynamic>;
        ...
        // Buat baru, mereka berdua benar" blm ada koneksi
